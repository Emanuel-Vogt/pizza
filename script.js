...
const defaultProducts = [
    ...
    { id: 22, num: "07", category: "xis-artesanais", type: "single", name: "X Tudo", desc: "Hambúrguer artesanal de coxão mole, filé de frango, bacon, calabresa, presunto, cheddar cremoso, ovo frito, mussarela, alface, tomate, milho, ervilha, maionese, ketchup e mostarda.", price: 45 },
    { id: 23, num: "08", category: "xis-artesanais", type: "single", name: "X Maná Especial", desc: "2 hambúrgueres artesanais de coxão mole, bacon crocante, cheddar cremoso, Catupiry, cebola caramelizada, ovo frito, mussarela, batata palha, maionese, ketchup e mostarda.", price: 48 },
    { id: 36, num: "09", category: "xis-artesanais", type: "single", name: "X Strogonoff de carne", desc: "Strogonoff de carne, cheddar cremoso, ovo frito, mussarela, batata palha, maionese, ketchup.", price: 40 },
